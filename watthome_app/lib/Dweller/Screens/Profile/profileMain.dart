          ...
          children: [
            ...
            Hero(
              ...
              child: ClipPath(
                ...
                child: Container(
                  height:
                      150, // Increase the height to extend through the app bar
            ...
            ClipPath(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: CustomColors.primaryAccentColor.withOpacity(0.4),
                ),
              ),
            ),
            Center(
                  ...
                  return ConstrainedBox(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildProfileOption(
                            context, Icons.family_restroom, 'My Family',
                            onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
  ...
  Widget _buildProfileOption(BuildContext context, IconData icon, String title,
    ...
    return Padding(
      ...
      child: ListTile(
        ...
        onTap: onTap,
        tileColor: CustomColors.tileColor,
